...
use hosp_weathter_full_cdg0s, clear
	...
	*- Sample processing: Remove city-year data with missing data
	...
	save treated_hosp_weathter_full_cdg0_window3, replace 
	
///////////////////////////////////////////////////////////////////////////////

global per="4" //set window size
...
use hosp_weathter_full_cdg0s, clear
	...
	*- Sample processing: Remove city-year data with missing data
	...
	save treated_hosp_weathter_full_cdg0_window5, replace 
	
///////////////////////////////////////////////////////////////////////////////

global per="13" //set window size
...
use hosp_weathter_full_cdg0s, clear
	...
	*- Sample processing: Remove city-year data with missing data
	...
	save treated_hosp_weathter_full_cdg0_window14, replace 
...
use hosp_weathter_full_cdg0s, clear
	...
	*- Generate bins of forecast errors for non-parametric estimation
			...
			winsor2 dif_TempHigh ,replace cuts(1 99)
	...
	*- Sample processing: Remove city-year data with missing data
	...
	save treated_hosp_weathter_full_cdg0_winsor, replace 
